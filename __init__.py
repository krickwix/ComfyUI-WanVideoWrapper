...
from .nodes_distributed import NODE_CLASS_MAPPINGS as DISTRIBUTED_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as DISTRIBUTED_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(DISTRIBUTED_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(DISTRIBUTED_NODE_DISPLAY_NAME_MAPPINGS)
