...
try:
    from .nodes_xdit_usp_loader import NODE_CLASS_MAPPINGS as XDIT_USP_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as XDIT_USP_NODE_DISPLAY_NAME_MAPPINGS
except ImportError:
    print("XDit+USP nodes not available due to missing dependencies")
    XDIT_USP_NODE_CLASS_MAPPINGS = {}
    XDIT_USP_NODE_DISPLAY_NAME_MAPPINGS = {}
try:
...
NODE_CLASS_MAPPINGS.update(XDIT_USP_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(XDIT_USP_NODE_DISPLAY_NAME_MAPPINGS)
